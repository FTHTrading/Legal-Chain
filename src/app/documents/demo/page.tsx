...
const PIPELINE_STEPS = [
  ...
  { label: 'Public Records Research', detail: 'Statutes, public records, and rules analyzed', icon: '📚' },
  { label: 'Content Assembly', detail: 'AI assembles document structure and arguments', icon: '✍️' },
  ...
  { label: 'PDF Rendering', detail: 'Standard formatting with DRAFT watermark', icon: '📄' },
  { label: 'Ready for Download', detail: 'Download as self-help template for your review', icon: '✅' },
];
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-5xl font-bold mb-3">
              AI-GENERATED<br /><span className="text-[var(--gold)]">DOCUMENT TEMPLATES.</span>
            </h1>
            <p className="text-base md:text-lg text-[var(--text-muted)] max-w-3xl">
              Our AI agents produce formatted document templates with proper structure —
              caption, numbered paragraphs, signature blocks, and certificate of service.
              These are self-help templates for reference only. Consult a licensed attorney before filing anything with a court.
            </p>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-2xl shadow-black/40 overflow-hidden relative">
                ...
                <div className="relative z-20 px-8 md:px-16 py-12 md:py-16" style={{ fontFamily: "'Times New Roman', 'Liberation Serif', serif", color: '#111', lineHeight: '1.6' }}>
                  ...
                  <div className="mt-16 ml-auto" style={{ maxWidth: '320px', fontSize: '13px' }}>
                    ...
                    <p>UNYKORN // ADVOCACY</p>
                    <p>Prepared for {doc.movingParty}</p>
                  ...
                  <div className="mt-12 text-center border-t border-gray-200 pt-4" style={{ fontSize: '10px', color: '#999' }}>
                    <p>Page 1 of {doc.pageCount} — Generated by UNYKORN // ADVOCACY AI Agent System</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-[var(--midnight)] rounded p-3 border border-emerald-500/15">
                      <p className="text-xs text-[var(--text-muted)] leading-relaxed">
                        <span className="text-emerald-400 font-bold">Properly formatted template</span> with proper caption block, case number, numbered paragraphs with real case law citations, signature block, certificate of service, DRAFT watermark, and confidence scoring.
                        <br /><br />
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[var(--navy-card)] border border-[rgba(201,168,76,0.15)] rounded-lg overflow-hidden">
                <div className="bg-emerald-500/5 border-b border-emerald-500/20 px-5 py-4">
                  ...
                  <p className="text-xs text-[var(--text-muted)]">{doc.label} — self-help template for review</p>
                </div>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="flex items-start gap-2 p-3 bg-amber-500/5 rounded border border-amber-500/15">
                    ...
                    <p className="text-[11px] text-amber-400/90 leading-relaxed">
                      <strong>AI-GENERATED TEMPLATE.</strong> This is a self-help template, not legal advice. Consult a licensed attorney before filing with any court.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.15)] rounded-lg p-5 text-center">
                ...
                <p className="text-xs text-[var(--text-muted)] mb-4">
                  Choose from 10 document types. Enter your details. Get a formatted template in seconds.
                </p>
                <Link
                  href="/documents"
